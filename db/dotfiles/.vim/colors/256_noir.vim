...
if has("gui_running") || &t_Co == 256
    ...
    hi StatusLineTerm cterm=bold,reverse ctermfg=245 ctermbg=16 gui=bold,reverse guifg=#8a8a8a guibg=#000000
    hi StatusLineTermNC cterm=reverse ctermfg=236 ctermbg=16 gui=reverse guifg=#303030 guibg=#000000
